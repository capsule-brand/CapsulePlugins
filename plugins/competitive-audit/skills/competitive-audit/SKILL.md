...
| 6 | Build the docx via `build_audit.js` with client-specific branding + auto-generated mode-aware methodology note. **Default output: `~/Downloads/<Client>_Competitive_Audit.docx`** unless the user names a different location. |
